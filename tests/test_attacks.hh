...
{
    auto moves = board::attacks_g.get_knight_attacks(56);
...
{
    auto moves = board::attacks_g.get_knight_attacks(26);
...
{
    auto moves = board::attacks_g.get_king_attacks(63);
...
{
    auto moves = board::attacks_g.get_king_attacks(11);
...
TEST (Attacks, bishop_attacks)
{
    ...
    auto moves = board::attacks_g.get_bishop_attacks(63, occupancy);
...
TEST (Attacks, bishop_attacks2)
{
    ...
    auto moves = board::attacks_g.get_bishop_attacks(36, occupancy);
...
TEST (Attacks, rook_attacks)
{
    ...
    auto moves = board::attacks_g.get_rook_attacks(56, occupancy);
...
TEST (Attacks, rook_attacks2)
{
    ...
    auto moves = board::attacks_g.get_rook_attacks(35, occupancy);
...
{
    auto moves = board::attacks_g.get_pawn_attacks(10, board::WHITE);
...
{
    auto moves = board::attacks_g.get_pawn_attacks(58, board::BLACK);
